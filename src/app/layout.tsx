...
export const metadata: Metadata = {
  title: "Legal Counsel | Premium Law Firm Services",
  description: "Expert legal services for corporate, litigation, IP, and personal matters. Experience, results, and client advocacy.",
  keywords: "law firm, attorney, legal services, corporate law, litigation",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Legal Counsel | Premium Law Firm Services",
    description: "Expert legal services for corporate, litigation, IP, and personal matters.",
    type: "website",
    siteName: "Legal Counsel"
  }
};
